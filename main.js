...
function createGeneratedRosePreset({ name, k, radius, pulse, phase = 0, hue }) {
  return {
    ...
    controls: [
      ...
      { key: "roseK", labelEn: "k", labelZh: "k 值", min: 2, max: 64, step: 1 },
...
function createGeneratedLissajousPreset({ name, ax, by, delta, scaleX, scaleY, hue }) {
  return {
    ...
    hueRange: 180,
    controls: [
      { key: "lissA", labelEn: "A freq", labelZh: "A 频率", min: 1, max: 32, step: 1 },
      { key: "lissB", labelEn: "B freq", labelZh: "B 频率", min: 1, max: 32, step: 1 },
...
function createGeneratedSpiroPreset({ name, rMajor, rMinor, d, scale, inward = true, hue }) {
  return {
    ...
    hueRange: 140,
    controls: [
      { key: "spiroMajor", labelEn: "R", labelZh: "R", min: 3, max: 32, step: 0.1 },
      { key: "spiroMinor", labelEn: "r", labelZh: "r", min: 0.8, max: 12, step: 0.1 },
      { key: "spiroD", labelEn: "d", labelZh: "d", min: 0.8, max: 14, step: 0.1 },
...
function createGeneratedSpiralPreset({ name, turns, radius, curve = 1, shell = false, hue }) {
  return {
    ...
    controls: [
      { key: "genSpiralTurns", labelEn: "Turns", labelZh: "圈数", min: 1.2, max: 16, step: 0.1 },
...
function createGeneratedFourierPreset({ name, a, b, c, d, hue }) {
  return {
    ...
    hueRange: 220,
    controls: [
      { key: "genFourierA", labelEn: "A", labelZh: "A", min: 1, max: 32, step: 1 },
      { key: "genFourierB", labelEn: "B", labelZh: "B", min: 1, max: 32, step: 1 },
      { key: "genFourierC", labelEn: "C", labelZh: "C", min: 1, max: 32, step: 1 },
      { key: "genFourierD", labelEn: "D", labelZh: "D", min: 1, max: 32, step: 1 },
...
function createGeneratedPolarPreset({ name, petals, wobble, radius, hue }) {
  return {
    ...
    hueRange: 160,
    controls: [
      { key: "genPolarPetals", labelEn: "Petals", labelZh: "花瓣", min: 2, max: 48, step: 1 },
      { key: "genPolarWobble", labelEn: "Wobble", labelZh: "扰动", min: 1, max: 48, step: 1 },
...
const generatedCurvePresets = [
  ...
  createGeneratedRosePreset({ name: "Rose Apex 26", k: 26, radius: 18.0, pulse: 1.80, phase: -0.045, hue: 132 }),
  createGeneratedRosePreset({ name: "Rose Apex 27", k: 27, radius: 17.8, pulse: 1.77, phase: -0.030, hue: 139 }),
  createGeneratedRosePreset({ name: "Rose Apex 28", k: 28, radius: 17.6, pulse: 1.74, phase: -0.015, hue: 146 }),
  createGeneratedRosePreset({ name: "Rose Apex 30", k: 30, radius: 17.5, pulse: 1.71, phase: 0.000, hue: 153 }),
  createGeneratedRosePreset({ name: "Rose Apex 32", k: 32, radius: 17.3, pulse: 1.68, phase: 0.015, hue: 160 }),
  createGeneratedRosePreset({ name: "Rose Apex 33", k: 33, radius: 17.1, pulse: 1.65, phase: 0.030, hue: 167 }),
  createGeneratedRosePreset({ name: "Rose Apex 34", k: 34, radius: 16.9, pulse: 1.62, phase: 0.045, hue: 174 }),
  createGeneratedRosePreset({ name: "Rose Apex 35", k: 35, radius: 16.7, pulse: 1.59, phase: -0.045, hue: 181 }),
  createGeneratedRosePreset({ name: "Rose Apex 36", k: 36, radius: 16.6, pulse: 1.56, phase: -0.030, hue: 188 }),
  createGeneratedRosePreset({ name: "Rose Apex 38", k: 38, radius: 16.4, pulse: 1.53, phase: -0.015, hue: 195 }),
  createGeneratedRosePreset({ name: "Rose Apex 39", k: 39, radius: 16.2, pulse: 1.50, phase: 0.000, hue: 202 }),
  createGeneratedRosePreset({ name: "Rose Apex 40", k: 40, radius: 16.0, pulse: 1.47, phase: 0.015, hue: 209 }),
  createGeneratedRosePreset({ name: "Rose Apex 42", k: 42, radius: 15.8, pulse: 1.44, phase: 0.030, hue: 216 }),
  createGeneratedRosePreset({ name: "Rose Apex 44", k: 44, radius: 15.7, pulse: 1.41, phase: 0.045, hue: 223 }),
  createGeneratedRosePreset({ name: "Rose Apex 45", k: 45, radius: 15.5, pulse: 1.38, phase: -0.045, hue: 230 }),
  createGeneratedRosePreset({ name: "Rose Apex 46", k: 46, radius: 15.3, pulse: 1.35, phase: -0.030, hue: 237 }),
  createGeneratedRosePreset({ name: "Rose Apex 48", k: 48, radius: 15.1, pulse: 1.32, phase: -0.015, hue: 244 }),
  createGeneratedRosePreset({ name: "Rose Apex 49", k: 49, radius: 14.9, pulse: 1.29, phase: 0.000, hue: 251 }),
  createGeneratedRosePreset({ name: "Rose Apex 50", k: 50, radius: 14.8, pulse: 1.26, phase: 0.015, hue: 258 }),
  createGeneratedRosePreset({ name: "Rose Apex 53", k: 53, radius: 14.6, pulse: 1.23, phase: 0.030, hue: 265 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 15:16", ax: 15, by: 16, delta: 0.42, scaleX: 23, scaleY: 25, hue: 12 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 15:22", ax: 15, by: 22, delta: 0.69, scaleX: 22, scaleY: 24, hue: 21 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 16:17", ax: 16, by: 17, delta: 0.96, scaleX: 21, scaleY: 23, hue: 30 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 16:21", ax: 16, by: 21, delta: 1.23, scaleX: 20, scaleY: 22, hue: 39 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 17:19", ax: 17, by: 19, delta: 1.50, scaleX: 19, scaleY: 21, hue: 48 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 17:24", ax: 17, by: 24, delta: 1.77, scaleX: 23, scaleY: 20, hue: 57 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 18:23", ax: 18, by: 23, delta: 2.04, scaleX: 22, scaleY: 25, hue: 66 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 19:20", ax: 19, by: 20, delta: 2.31, scaleX: 21, scaleY: 24, hue: 75 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 19:26", ax: 19, by: 26, delta: 2.58, scaleX: 20, scaleY: 23, hue: 84 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 20:21", ax: 20, by: 21, delta: 0.42, scaleX: 19, scaleY: 22, hue: 93 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 20:27", ax: 20, by: 27, delta: 0.69, scaleX: 23, scaleY: 21, hue: 102 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 21:22", ax: 21, by: 22, delta: 0.96, scaleX: 22, scaleY: 20, hue: 111 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 21:29", ax: 21, by: 29, delta: 1.23, scaleX: 21, scaleY: 25, hue: 120 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 22:23", ax: 22, by: 23, delta: 1.50, scaleX: 20, scaleY: 24, hue: 129 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 22:31", ax: 22, by: 31, delta: 1.77, scaleX: 19, scaleY: 23, hue: 138 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 23:24", ax: 23, by: 24, delta: 2.04, scaleX: 23, scaleY: 22, hue: 147 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 24:25", ax: 24, by: 25, delta: 2.31, scaleX: 22, scaleY: 21, hue: 156 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 25:27", ax: 25, by: 27, delta: 2.58, scaleX: 21, scaleY: 20, hue: 165 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 26:29", ax: 26, by: 29, delta: 0.42, scaleX: 20, scaleY: 25, hue: 174 }),
  createGeneratedLissajousPreset({ name: "Lissajous Apex 28:31", ax: 28, by: 31, delta: 0.69, scaleX: 19, scaleY: 24, hue: 183 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 21", rMajor: 15.0, rMinor: 4.2, d: 5.6, scale: 1.05, inward: true, hue: 202 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 22", rMajor: 15.9, rMinor: 4.7, d: 6.1, scale: 1.17, inward: false, hue: 210 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 23", rMajor: 16.8, rMinor: 5.1, d: 6.7, scale: 1.29, inward: true, hue: 218 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 24", rMajor: 17.7, rMinor: 5.6, d: 7.2, scale: 1.41, inward: false, hue: 226 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 25", rMajor: 18.6, rMinor: 6.0, d: 7.8, scale: 1.53, inward: true, hue: 234 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 26", rMajor: 19.5, rMinor: 6.5, d: 8.3, scale: 1.05, inward: false, hue: 242 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 27", rMajor: 20.4, rMinor: 6.9, d: 8.9, scale: 1.17, inward: true, hue: 250 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 28", rMajor: 21.3, rMinor: 4.2, d: 9.4, scale: 1.29, inward: false, hue: 258 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 29", rMajor: 22.2, rMinor: 4.7, d: 5.6, scale: 1.41, inward: true, hue: 266 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 30", rMajor: 23.1, rMinor: 5.1, d: 6.1, scale: 1.53, inward: false, hue: 274 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 31", rMajor: 15.0, rMinor: 5.6, d: 6.7, scale: 1.05, inward: true, hue: 282 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 32", rMajor: 15.9, rMinor: 6.0, d: 7.2, scale: 1.17, inward: false, hue: 290 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 33", rMajor: 16.8, rMinor: 6.5, d: 7.8, scale: 1.29, inward: true, hue: 298 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 34", rMajor: 17.7, rMinor: 6.9, d: 8.3, scale: 1.41, inward: false, hue: 306 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 35", rMajor: 18.6, rMinor: 4.2, d: 8.9, scale: 1.53, inward: true, hue: 314 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 36", rMajor: 19.5, rMinor: 4.7, d: 9.4, scale: 1.05, inward: false, hue: 322 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 37", rMajor: 20.4, rMinor: 5.1, d: 5.6, scale: 1.17, inward: true, hue: 330 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 38", rMajor: 21.3, rMinor: 5.6, d: 6.1, scale: 1.29, inward: false, hue: 338 }),
  createGeneratedSpiroPreset({ name: "Hypotrochoid Apex 39", rMajor: 22.2, rMinor: 6.0, d: 6.7, scale: 1.41, inward: true, hue: 346 }),
  createGeneratedSpiroPreset({ name: "Epitrochoid Apex 40", rMajor: 23.1, rMinor: 6.5, d: 7.2, scale: 1.53, inward: false, hue: 354 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 01", a: 14, b: 19, c: 16, d: 21, hue: 22 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 02", a: 15, b: 21, c: 19, d: 25, hue: 33 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 03", a: 16, b: 23, c: 22, d: 29, hue: 44 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 04", a: 17, b: 25, c: 25, d: 22, hue: 55 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 05", a: 18, b: 27, c: 18, d: 26, hue: 66 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 06", a: 19, b: 29, c: 21, d: 30, hue: 77 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 07", a: 20, b: 20, c: 24, d: 23, hue: 88 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 08", a: 21, b: 22, c: 17, d: 27, hue: 99 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 09", a: 22, b: 24, c: 20, d: 31, hue: 110 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 10", a: 23, b: 26, c: 23, d: 24, hue: 121 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 11", a: 14, b: 28, c: 16, d: 28, hue: 132 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 12", a: 15, b: 19, c: 19, d: 21, hue: 143 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 13", a: 16, b: 21, c: 22, d: 25, hue: 154 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 14", a: 17, b: 23, c: 25, d: 29, hue: 165 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 15", a: 18, b: 25, c: 18, d: 22, hue: 176 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 16", a: 19, b: 27, c: 21, d: 26, hue: 187 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 17", a: 20, b: 29, c: 24, d: 30, hue: 198 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 18", a: 21, b: 20, c: 17, d: 23, hue: 209 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 19", a: 22, b: 22, c: 20, d: 27, hue: 220 }),
  createGeneratedFourierPreset({ name: "Fourier Apex 20", a: 23, b: 24, c: 23, d: 31, hue: 231 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 1", turns: 10.2, radius: 24, curve: 0.95, hue: 182 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 2", turns: 10.8, radius: 23, curve: 1.11, hue: 192 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 3", turns: 11.3, radius: 22, curve: 1.27, hue: 202 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 4", turns: 11.8, radius: 21, curve: 1.43, hue: 212 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 5", turns: 12.4, radius: 24, curve: 1.59, hue: 222 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 6", turns: 12.9, radius: 23, curve: 0.95, hue: 232 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 7", turns: 13.5, radius: 22, curve: 1.11, hue: 242 }),
  createGeneratedSpiralPreset({ name: "Spiral Apex 8", turns: 14.1, radius: 21, curve: 1.27, hue: 252 }),
  createGeneratedHeartPreset({ name: "Heart Apex 1", scale: 0.98, squeeze: 0.82, beat: 1.70, hue: 302 }),
  createGeneratedHeartPreset({ name: "Heart Apex 2", scale: 1.02, squeeze: 0.94, beat: 1.82, hue: 311 }),
  createGeneratedHeartPreset({ name: "Heart Apex 3", scale: 1.06, squeeze: 1.06, beat: 1.94, hue: 320 }),
  createGeneratedHeartPreset({ name: "Heart Apex 4", scale: 1.10, squeeze: 1.18, beat: 2.06, hue: 329 }),
  createGeneratedHeartPreset({ name: "Heart Apex 5", scale: 1.14, squeeze: 0.82, beat: 2.18, hue: 338 }),
  createGeneratedHeartPreset({ name: "Heart Apex 6", scale: 1.18, squeeze: 0.94, beat: 2.30, hue: 347 }),
  createGeneratedPolarPreset({ name: "Polar Apex 30-21", petals: 30, wobble: 21, radius: 12.0, hue: 252 }),
  createGeneratedPolarPreset({ name: "Polar Apex 32-22", petals: 32, wobble: 22, radius: 11.6, hue: 265 }),
  createGeneratedPolarPreset({ name: "Polar Apex 34-23", petals: 34, wobble: 23, radius: 11.2, hue: 278 }),
  createGeneratedPolarPreset({ name: "Polar Apex 36-24", petals: 36, wobble: 24, radius: 10.8, hue: 291 }),
  createGeneratedPolarPreset({ name: "Polar Apex 38-25", petals: 38, wobble: 25, radius: 10.4, hue: 304 }),
  createGeneratedPolarPreset({ name: "Polar Apex 40-26", petals: 40, wobble: 26, radius: 10.0, hue: 317 }),
];
