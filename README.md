...
- 34 mathematical loaders today, with a roadmap to keep expanding in focused waves
- curve families such as rose curves, Lissajous curves, hypotrochoids, epicycloids, astroids, superellipses, projected knots, cardioids, infinity curves, shell spirals, superformula stars, nephroids, Maurer-style rose chords, and Fourier-style paths
